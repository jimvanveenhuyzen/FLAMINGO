...
positions = np.genfromtxt('positions_halo0_hydro.txt',delimiter='')
positions_stars = np.genfromtxt('positions_halo0_hydro_stars.txt',delimiter='')
...
ax.scatter(positions_stars[:,0],positions_stars[:,1],s=1,label='stars')
